...
interface LotoRow {
  ...
  hm: number;
  qty: number;
  refueling_start: string; // timestamptz
}
...
const toTimestamptzGMT8 = (value: any) => {
  /**
   * Excel datetime → number
   * Kita konversi langsung ke JS Date
   */
    ...
    <div className="border rounded p-4">
      ...
      <table className="w-full text-sm border">
        ...
        <tbody>
          ...
          <tr className="font-semibold bg-gray-50">
            <td className="border px-2 py-1">TOTAL RECORD</td>
            <td className="border px-2 py-1 text-right">
              {rowData.length}
            </td>
          </tr>
