    ...
    <div className={`relative flex ${className}`}>
      ...
      >
            ...
            >
             <svg
              ...
              >
                {isMaximized ? (
                    <path
                        d="M2.5 2.5h4v1.5H4v2.5H2.5v-4zm11 0h-4v1.5h2.5v2.5h1.5v-4zm0 11h-4v-1.5h2.5v-2.5h1.5v4zm-11 0h4v-1.5H4v-2.5H2.5v4z"
                        fill=""
                    />
                ) : (
                    <path
                        d="M2.5 4V2.5h4v1.5H4v2.5H2.5zm11 0V2.5h-4v1.5h2.5v2.5h1.5zm-11 8v1.5h4v-1.5H4v-2.5H2.5zm11 0v1.5h-4v-1.5h2.5v-2.5h1.5z"
                        fill=""
                    />
                )}
              </svg>
        ...
        <button  
            ...
            className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm text-black dark:text-white hover:bg-gray dark:hover:bg-meta-4"
        >
          <svg
            className="fill-current"
            width="16"
        ...
        <button 
            ...
            className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4 text-meta-1 hover:text-meta-1"
        >
          <svg
            className="fill-current"
            width="16"
...
export default DropdownProfileEdit;
