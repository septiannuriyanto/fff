...
const SignIn: React.FC = () => {
  ...
  const handleNrpChange = async (
    ...
    try {
      // Query the table 'manpower' to find the email
                  ...
                  <button
                    ...
                    className={`w-full rounded-lg border border-primary p-4 text-white transition ${
                      error
                        ...
                        : 'cursor-pointer bg-primary hover:bg-opacity-90'
                    }`}
                    disabled={!!error} // Disable button if error is present
                  >
                    Submit
                  </button>
                </div>
