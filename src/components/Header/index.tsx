...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-[998] flex w-full bg-white/70 backdrop-blur-md dark:bg-boxdark/70 drop-shadow-1 dark:drop-shadow-none border-b border-slate-100/50 dark:border-slate-800/50">
      <div className="flex flex-grow items-center justify-between px-4 py-3 shadow-2 md:px-6 2xl:px-11 lg:justify-end">
