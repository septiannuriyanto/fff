...
const ChartThree: React.FC<ChartThreeProps> = ({ series, labels }) => {
  ...
  const options: ApexOptions = {
    ...
    colors: [theme.ui.primaryColor, '#6577F3', '#8FD0EF', '#0FADCF'], // Updated to use theme primary color
    labels: labels,
    legend: {
      show: false,
      position: 'bottom',
  ...
  return (
    <div
      className="col-span-12 rounded-xl p-7.5 shadow-card transition-all duration-300 sm:px-7.5 xl:col-span-5"
      style={{
