...
const Sidebar = ({ sidebarOpen, setSidebarOpen, role }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`sidebar-main ${isShown} absolute left-0 top-0 z-40 flex h-screen w-65 flex-col overflow-y-hidden bg-white duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
