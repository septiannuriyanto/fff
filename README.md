# FFF (FUEL FEASIBILITY FOR FLEET)

FFF is a dashboard to monitor every activity regarding to fuel management. FFF built on top of React Tail Admin dashboard.
